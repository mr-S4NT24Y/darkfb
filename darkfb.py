...
def loginSC():
	...
	if username =="Mr" and password =="S4NTUY":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://youtube.com/channel/UCVX-ZwkQ4FVbRdk7AGuF_SA')
				menu()
